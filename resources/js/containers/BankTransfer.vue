...
<div class="bank-transfer">
    <b-modal
        ...
        dialog-class="bank-transfer__modal-container"
        content-class="bank-transfer__modal"
    >
        <div class="bank-transfer__container">
            <div
                class="bank-transfer__row"
                ref="container"
            >
                <div class="bank-transfer__short">
                    <bank-transfer-data
                        ref="panel"
                        :item="item"
                        @hide-cart="hideCart"
...
import BankTransferData from './BankTransferData.vue'
